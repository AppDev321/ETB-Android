...
object ViewUtils {
    ...
    fun updateTbProgramText(view: TextView) {
        val context = view.context
        view.text = TextUtils.concat(
            context.getString(R.string.provincial),
            " ",
            Utilities.changeForeground(
            ...
            " ",
            context.getString(R.string.program),
            context.getString(R.string._punjab)
        )
//        view.text = HtmlCompat.fromHtml(
//            view.context.getString(R.string.p_provincial_span_style_color_ff0000_tb_span_control_span_style_color_339966_program_span_punjab_p),
